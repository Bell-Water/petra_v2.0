...
public class ScheduleController {
	...
	@PatchMapping("/schedule/plan")
	public Response updatePlanOrder(@AuthenticatedUser User user, @RequestBody PlanDto planDto) {


		return new Response(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
	}

	@DeleteMapping("/schedule/plans/{planId}")
	public Response deletePlan(@AuthenticatedUser User user, @PathVariable("planId") Long planId) {

		return planService.deletePlan(user, planId);
	}
}
